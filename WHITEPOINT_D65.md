...
The sRGB and BT.709 specifications declare specific 4-digit values as definitional. The white point of sRGB *is* (0.3127, 0.3290)—not because this approximates some platonic ideal of D65, but because the standard says so.

**Using "more accurate" D65 values produces a different color space:**

- Using (0.31272, 0.32903) instead of (0.3127, 0.3290) when deriving sRGB matrices creates matrices for a subtly different—and non-conforming—color space.
