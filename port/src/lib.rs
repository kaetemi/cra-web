...
mod tests {
    ...
    fn test_basic_oklab_smoke() {
        ...
        let result = color_correct_basic_oklab(&input, 2, 2, &reference, 2, 2, false, false);
        assert_eq!(result.len(), 12);

        // Also test with f32 histogram
        let result_f32 = color_correct_basic_oklab(&input, 2, 2, &reference, 2, 2, false, true);
        assert_eq!(result_f32.len(), 12);
    }
    ...
    fn test_cra_oklab_smoke() {
        ...
        let result = color_correct_cra_oklab(&input, 2, 2, &reference, 2, 2, false, false);
        assert_eq!(result.len(), 12);

        // Also test with f32 histogram
        let result_f32 = color_correct_cra_oklab(&input, 2, 2, &reference, 2, 2, false, true);
        assert_eq!(result_f32.len(), 12);
    }
    ...
    fn test_tiled_oklab_smoke() {
        ...
        let result = color_correct_tiled_oklab(&input, 2, 2, &reference, 2, 2, true, false);
        assert_eq!(result.len(), 12);

        // Test without tiled luminosity (AB only)
        let result_ab = color_correct_tiled_oklab(&input, 2, 2, &reference, 2, 2, false, false);
        assert_eq!(result_ab.len(), 12);

        // Also test with f32 histogram
        let result_f32 = color_correct_tiled_oklab(&input, 2, 2, &reference, 2, 2, true, true);
        assert_eq!(result_f32.len(), 12);
    }
}
