...
// Re-export ColorFormat and utilities from color_format module
pub use super::color_format::{
    ColorFormat, is_valid_format, format_supports_binary, format_total_bits, format_is_grayscale
};

// Re-export RGB666 functions
pub use super::rgb666::{
    encode_rgb666_row_aligned, encode_rgb666_row_aligned_stride, decode_rgb666_raw
};
