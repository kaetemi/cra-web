...
pub const XYZ_TO_DISPLAY_P3: [[f64; 3]; 3] = [
    ...
    [-0.8294889695615748, 1.7626640603183468, 0.023624685841943598],
...
pub const XYZ_TO_ADOBE_RGB: [[f64; 3]; 3] = [
    ...
    [-0.9692436362808798, 1.8759675015077206, 0.041555057407175605],
    [0.013444280632031154, -0.11836239223101841, 1.0151749943912058],
];
...
pub const PROPHOTO_RGB_TO_XYZ: [[f64; 3]; 3] = [
    ...
    [0.28803704804175084, 0.7118773192373937, 0.00008563272085539291],
    [0.0, 0.0, 0.8249],
];
...
pub const XYZ_TO_PROPHOTO_RGB: [[f64; 3]; 3] = [
    ...
    [-0.5445964045699176, 1.5081604916604545, 0.020535048643302134],
...
pub const REC2020_TO_XYZ: [[f64; 3]; 3] = [
    ...
    [0.0, 0.028072693049087435, 1.0609850577107909],
];
...
pub const BT601_625_TO_XYZ: [[f64; 3]; 3] = [
    ...
    [0.020182209999839145, 0.12955337375296855, 0.9393221670070708],
];
...
pub const BT601_525_TO_XYZ: [[f64; 3]; 3] = [
    ...
    [0.018739090650447113, 0.11193392673603976, 0.9583847333733914],
];
...
pub const XYZ_TO_BT601_525: [[f64; 3]; 3] = [
    ...
    [-1.069047559853815, 1.9777788827287865, 0.035171419337195135],
...
pub const XYZ_TO_NTSC_1953: [[f64; 3]; 3] = [
    ...
    [-0.9846224942838822, 1.999082033849094, -0.028306940395107682],
...
pub const ADAPT_D50_TO_D65: [[f64; 3]; 3] = [
    ...
    [0.012328703174821272, -0.020535307654303295, 1.330713689917589],
];

/// Chromatic adaptation: D65 → D50 (for D65 spaces to ProPhoto RGB).
pub const ADAPT_D65_TO_D50: [[f64; 3]; 3] = [
    [1.0478860032225505, 0.022918765174779525, -0.05021609531173302],
    [0.029581782498003504, 0.9904835184905488, -0.0170787077044827],
    [-0.009251880839208838, 0.015072607487031327, 0.7516781336176036],
];
...
pub const APPLE_RGB_TO_SRGB: [[f64; 3]; 3] = [
    [1.0687158545276882, -0.07860969598003947, 0.009893841452351393],
    [0.024106255134918212, 0.9600709276463433, 0.01582281721873901],
    [0.0017343533570501682, 0.029741144465361344, 0.9685245021775882],
];

/// Linear sRGB → Linear Apple RGB matrix.
pub const SRGB_TO_APPLE_RGB: [[f64; 3]; 3] = [
    [0.9339874165842391, 0.07680843758720021, -0.010795854171439023],
    [-0.02343562489314104, 1.0401898373846301, -0.016754212491489416],
    [-0.0009528534422594825, -0.03207936312068568, 1.0330322165629455],
];
...
pub const REC2020_TO_SRGB: [[f64; 3]; 3] = [
    ...
    [-0.12455047452159052, 1.13289989712596, -0.008349422604369487],
...
pub const SRGB_TO_REC2020: [[f64; 3]; 3] = [
    [0.627403895934699, 0.32928303837788375, 0.043313065687417274],
    [0.06909728935823199, 0.919540395075459, 0.011362315566309154],
    [0.016391438875150228, 0.08801330787722578, 0.895595253247624],
];
...
pub const PROPHOTO_RGB_TO_SRGB: [[f64; 3]; 3] = [
    ...
    [-0.22879805605430628, 1.2317302821191265, -0.002932226064820291],
...
pub const SRGB_TO_PROPHOTO_RGB: [[f64; 3]; 3] = [
    ...
    [0.016874999965299283, 0.1176715222416342, 0.865453477793067],
];
...
pub mod cielab {
    ...
    pub const EPSILON: f64 = 0.008856451679035631;
...
pub mod f32 {
    ...
    pub const XYZ_TO_DISPLAY_P3: [[f32; 3]; 3] = [
        ...
        [-0.8294889695615748 as f32, 1.7626640603183468 as f32, 0.023624685841943598 as f32],
    ...
    pub const XYZ_TO_ADOBE_RGB: [[f32; 3]; 3] = [
        ...
        [-0.9692436362808798 as f32, 1.8759675015077206 as f32, 0.041555057407175605 as f32],
        [0.013444280632031154 as f32, -0.11836239223101841 as f32, 1.0151749943912058 as f32],
    ];

    pub const PROPHOTO_RGB_TO_XYZ: [[f32; 3]; 3] = [
        [0.7976661108038989 as f32, 0.13519231336302714 as f32, 0.03134157583307381 as f32],
        [0.28803704804175084 as f32, 0.7118773192373937 as f32, 0.00008563272085539291 as f32],
    ...
    pub const XYZ_TO_PROPHOTO_RGB: [[f32; 3]; 3] = [
        ...
        [-0.5445964045699176 as f32, 1.5081604916604545 as f32, 0.020535048643302134 as f32],
    ...
    pub const REC2020_TO_XYZ: [[f32; 3]; 3] = [
        ...
        [0.0 as f32, 0.028072693049087435 as f32, 1.0609850577107909 as f32],
    ];
    ...
    pub const BT601_625_TO_XYZ: [[f32; 3]; 3] = [
        ...
        [0.020182209999839145 as f32, 0.12955337375296855 as f32, 0.9393221670070708 as f32],
    ];
    ...
    pub const BT601_525_TO_XYZ: [[f32; 3]; 3] = [
        ...
        [0.018739090650447113 as f32, 0.11193392673603976 as f32, 0.9583847333733914 as f32],
    ];
    pub const XYZ_TO_BT601_525: [[f32; 3]; 3] = [
        [3.506003282724663 as f32, -1.7397907263028323 as f32, -0.5440582683627413 as f32],
        [-1.069047559853815 as f32, 1.9777788827287865 as f32, 0.035171419337195135 as f32],
    ...
    pub const XYZ_TO_NTSC_1953: [[f32; 3]; 3] = [
        ...
        [-0.9846224942838822 as f32, 1.999082033849094 as f32, -0.028306940395107682 as f32],
    ...
    pub const BRADFORD_INV: [[f32; 3]; 3] = [
        ...
        [-0.008528664575177328 as f32, 0.04004282165408487 as f32, 0.9684866957875502 as f32],
    ];
    ...
    pub const ADAPT_D50_TO_D65: [[f32; 3]; 3] = [
        ...
        [0.012328703174821272 as f32, -0.020535307654303295 as f32, 1.330713689917589 as f32],
    ];
    pub const ADAPT_D65_TO_D50: [[f32; 3]; 3] = [
        [1.0478860032225505 as f32, 0.022918765174779525 as f32, -0.05021609531173302 as f32],
        [0.029581782498003504 as f32, 0.9904835184905488 as f32, -0.0170787077044827 as f32],
        [-0.009251880839208838 as f32, 0.015072607487031327 as f32, 0.7516781336176036 as f32],
    ];
    ...
    pub const APPLE_RGB_TO_SRGB: [[f32; 3]; 3] = [
        [1.0687158545276882 as f32, -0.07860969598003947 as f32, 0.009893841452351393 as f32],
        [0.024106255134918212 as f32, 0.9600709276463433 as f32, 0.01582281721873901 as f32],
        [0.0017343533570501682 as f32, 0.029741144465361344 as f32, 0.9685245021775882 as f32],
    ];
    pub const SRGB_TO_APPLE_RGB: [[f32; 3]; 3] = [
        [0.9339874165842391 as f32, 0.07680843758720021 as f32, -0.010795854171439023 as f32],
        [-0.02343562489314104 as f32, 1.0401898373846301 as f32, -0.016754212491489416 as f32],
        [-0.0009528534422594825 as f32, -0.03207936312068568 as f32, 1.0330322165629455 as f32],
    ];
    ...
    pub const REC2020_TO_SRGB: [[f32; 3]; 3] = [
        ...
        [-0.12455047452159052 as f32, 1.13289989712596 as f32, -0.008349422604369487 as f32],
        [-0.01815076335490522 as f32, -0.10057889800800737 as f32, 1.1187296613629125 as f32],
    ];
    pub const SRGB_TO_REC2020: [[f32; 3]; 3] = [
        [0.627403895934699 as f32, 0.32928303837788375 as f32, 0.043313065687417274 as f32],
        [0.06909728935823199 as f32, 0.919540395075459 as f32, 0.011362315566309154 as f32],
        [0.016391438875150228 as f32, 0.08801330787722578 as f32, 0.895595253247624 as f32],
    ];

    pub const PROPHOTO_RGB_TO_SRGB: [[f32; 3]; 3] = [
        [2.0342181530788603 as f32, -0.7275364732863576 as f32, -0.30668167979250266 as f32],
        [-0.22879805605430628 as f32, 1.2317302821191265 as f32, -0.002932226064820291 as f32],
    ...
    pub const SRGB_TO_PROPHOTO_RGB: [[f32; 3]; 3] = [
        ...
        [0.016874999965299283 as f32, 0.1176715222416342 as f32, 0.865453477793067 as f32],
    ];
    ...
    pub const CIELAB_EPSILON: f32 = 0.008856451679035631 as f32;
