...
pub mod f32 {
    ...
    pub const D65_Y: f32 = 1.00000000000000000 as f32;
    ...
    pub const D50_Y: f32 = 1.00000000000000000 as f32;
    ...
    pub const D65_CHROMATICITY: [f32; 2] = [0.31269999999999998 as f32, 0.32900000000000001 as f32];
    pub const D50_CHROMATICITY: [f32; 2] = [0.34570000000000001 as f32, 0.35849999999999999 as f32];
    ...
    pub const PROPHOTO_RGB_TO_XYZ: [[f32; 3]; 3] = [
        ...
        [0.00000000000000000 as f32, 0.00000000000000000 as f32, 0.82510460251046014 as f32],
    ];
    pub const XYZ_TO_PROPHOTO_RGB: [[f32; 3]; 3] = [
        ...
        [0.00000000000000000 as f32, 0.00000000000000000 as f32, 1.21196754563894538 as f32],
    ];
    ...
    pub const SRGB_THRESHOLD: f32 = 0.00313080000000000 as f32;
    /// sRGB decode threshold (encoded space)
    pub const SRGB_DECODE_THRESHOLD: f32 = 0.04044993600000000 as f32;
    pub const SRGB_LINEAR_SLOPE: f32 = 12.91999999999999993 as f32;
    pub const SRGB_GAMMA: f32 = 2.4;
    pub const SRGB_SCALE: f32 = 1.055;
    pub const SRGB_OFFSET: f32 = 0.055;

    pub const ADOBE_RGB_GAMMA: f32 = 2.19921875000000000 as f32;
    pub const APPLE_RGB_GAMMA: f32 = 1.80000000000000004 as f32;

    pub const PROPHOTO_THRESHOLD: f32 = 0.00195312500000000 as f32;
    pub const PROPHOTO_DECODE_THRESHOLD: f32 = 0.03125000000000000 as f32;
    pub const PROPHOTO_LINEAR_MULTIPLIER: f32 = 16.00000000000000000 as f32;
    pub const PROPHOTO_GAMMA: f32 = 1.80000000000000004 as f32;
    ...
    pub const OKLAB_M1: [[f32; 3]; 3] = [
        [0.41222147079999999 as f32, 0.53633253630000000 as f32, 0.05144599290000000 as f32],
        [0.21190349820000001 as f32, 0.68069954509999997 as f32, 0.10739695660000000 as f32],
        [0.08830246190000000 as f32, 0.28171883759999999 as f32, 0.62997870050000004 as f32],
    ];

    /// OKLab M2: LMS' → Lab
    pub const OKLAB_M2: [[f32; 3]; 3] = [
        [0.21045425530000000 as f32, 0.79361778500000002 as f32, -0.00407204680000000 as f32],
        [1.97799849510000003 as f32, -2.42859220500000017 as f32, 0.45059370989999997 as f32],
        [0.02590403710000000 as f32, 0.78277176620000000 as f32, -0.80867576600000002 as f32],
    ];

    /// OKLab M1_inv: LMS → Linear sRGB
    pub const OKLAB_M1_INV: [[f32; 3]; 3] = [
        [4.07674166209999989 as f32, -3.30771159129999992 as f32, 0.23096992920000001 as f32],
        [-1.26843800459999989 as f32, 2.60975740109999998 as f32, -0.34131939649999998 as f32],
        [-0.00419608630000000 as f32, -0.70341861470000000 as f32, 1.70761470100000001 as f32],
    ];

    /// OKLab M2_inv: Lab → LMS'
    pub const OKLAB_M2_INV: [[f32; 3]; 3] = [
        [1.00000000000000000 as f32, 0.39633777739999998 as f32, 0.21580375730000001 as f32],
        [1.00000000000000000 as f32, -0.10556134580000000 as f32, -0.06385417280000000 as f32],
        [1.00000000000000000 as f32, -0.08948417750000000 as f32, -1.29148554800000004 as f32],
    ];
    ...
    pub const YCBCR_KR: f32 = 0.21260000000000001 as f32;
    pub const YCBCR_KG: f32 = 0.71519999999999995 as f32;
    pub const YCBCR_KB: f32 = 0.07220000000000000 as f32;
    pub const YCBCR_CB_SCALE: f32 = 1.85559999999999992 as f32;
    pub const YCBCR_CR_SCALE: f32 = 1.57479999999999998 as f32;

    pub const RGB_TO_YCBCR: [[f32; 3]; 3] = [
        [0.21260000000000001 as f32, 0.71519999999999995 as f32, 0.07220000000000000 as f32],
        [-0.11457210605733996 as f32, -0.38542789394266003 as f32, 0.50000000000000000 as f32],
        [0.50000000000000000 as f32, -0.45415290830581656 as f32, -0.04584709169418339 as f32],
    ];
    pub const YCBCR_TO_RGB: [[f32; 3]; 3] = [
        [1.00000000000000000 as f32, 0.00000000000000000 as f32, 1.57479999999999998 as f32],
        [1.00000000000000000 as f32, -0.18732427293064879 as f32, -0.46812427293064884 as f32],
        [1.00000000000000000 as f32, 1.85559999999999992 as f32, 0.00000000000000000 as f32],
    ];
