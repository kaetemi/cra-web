...
/// Rescale using Peaked Cosine (AVIR-style) windowed sinc filter
///
/// This filter adapts its parameters based on the scale factor:
/// - Downscaling: uses lowpass filter with scale-dependent cutoff and length
/// - Upscaling: uses interpolation filter parameters
pub fn rescale_peaked_cosine_pixels(
    src: &[Pixel4],
    src_width: usize,
    src_height: usize,
    dst_width: usize,
    ...
    // Precompute weights using scale-dependent Peaked Cosine parameters
...
/// Alpha-aware Peaked Cosine rescale
pub fn rescale_peaked_cosine_alpha_pixels(
    src: &[Pixel4],
    src_width: usize,
    src_height: usize,
    dst_width: usize,
