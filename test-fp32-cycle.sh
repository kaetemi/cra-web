#!/bin/bash
# Test script for PNG <-> FP32 safetensors cycling
# FP32 should be lossless - this serves as a control/baseline
...
OUTPUT_DIR="${SCRIPT_DIR}/test_output/fp32_cycle"
...
echo "=========================================="
echo "FP32 Safetensors Cycle Test"
echo "=========================================="
echo ""
...
echo ""
echo "Note: FP32 should be lossless - all cycles should be identical to original."
echo ""
echo "Done!"
